package com.gec.cpapp.contentprovider;
...
import com.gec.cpapp.TodoDatabaseHelper;
import com.gec.cpapp.TodoTable;
...
public class MyTodoContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.gec.cpapp.contentprovider";
...
// Set the table
        ...
        Log.i(this.getClass().getName(), "db.isDatabaseIntegrityOk=" + db.isDatabaseIntegrityOk());
        Log.i(this.getClass().getName(), "projection.length=" + projection.length);
        Log.i(this.getClass().getName(), "qb.getTables=" + queryBuilder.getTables());
